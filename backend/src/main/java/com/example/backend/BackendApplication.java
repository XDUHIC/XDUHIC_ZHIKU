    ...
    public CommandLineRunner dbMigrate(JdbcTemplate jdbc) {
        return args -> {
            ...
            try {
                ...
                try { jdbc.execute("ALTER TABLE articles ADD COLUMN IF NOT EXISTS source VARCHAR(20) DEFAULT NULL COMMENT 'undergrad/postgrad'"); } catch (Exception ignored) {}
            }
            try {
            ...
            try {
                ...
                try { jdbc.execute("ALTER TABLE resources ADD COLUMN IF NOT EXISTS content_url VARCHAR(500) DEFAULT NULL COMMENT 'Markdown内容路径'"); } catch (Exception ignored) {}
            }
            ...
            try {
                ...
                try { jdbc.execute("ALTER TABLE resources ADD COLUMN IF NOT EXISTS source VARCHAR(20) DEFAULT NULL COMMENT 'undergrad-本科/postgrad-研究生'"); } catch (Exception ignored) {}
            }
            try {
            ...
            try {
                ...
                if (hasTags == null || hasTags == 0) jdbc.execute("ALTER TABLE shares ADD COLUMN tags VARCHAR(255) DEFAULT NULL COMMENT '标签，逗号分隔'");
            } catch (Exception ignored) {}
            try {
                ...
                if (hasAuthorId == null || hasAuthorId == 0) jdbc.execute("ALTER TABLE shares ADD COLUMN author_id BIGINT DEFAULT NULL COMMENT '作者ID'");
            } catch (Exception ignored) {}
            // 答疑解惑：问题表
            try {
